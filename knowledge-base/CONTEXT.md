# knowledge-base — materiais da Clara

Três gavetas com papéis distintos. Saber qual abrir evita carregar contexto inútil.
...
- Material novo entra via `_inbox/` + triagem — não criar arquivo direto aqui sem proveniência.
- Todo arquivo vindo do Drive tem frontmatter com o link do original (manter ao editar).
- Conteúdo de clientes dela: **sempre anonimizado** antes de entrar.
- `origem-entrega-drive.md` registra a primeira entrega (2026-06-12) e o que veio nela.
